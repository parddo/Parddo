            ...
            <section className="container setc-main" id="Experience">
                <SectionOne icoClass="fas fa-pencil-alt icon-section"  tlite=" Experiencia laboral" description="A través de la experiencia de los últimos tres años, he aprendido a implementar diferentes tecnologías web para la sistematización de procesos, lo que me ha permitido detectar errores y posibilidades de automatización en los mismos." />
                 <div className="companies">
                    <Companie position="Técnico de soporte" date="FEB-2021 -- HOY"  companie="Latinoamérica Hosting" urlName="www.latinoamericahosting.com" url="https://www.latinoamericahosting.com.co" description="Atención al usuario, asesoría comercial y soporte técnico." />
                    <Companie position="Asistente de sistemas" date="DIC-2020 -- ENE-2021"  companie="Speed Domicilios" urlName="www.speeddomicilios.co" url="https://www.speeddomicilios.co" description="Sistematización y automatización de procesos en las áreas de operaciones y gestión humana." />
